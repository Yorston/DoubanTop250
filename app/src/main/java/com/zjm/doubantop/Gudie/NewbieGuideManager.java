package com.zjm.doubantop.Gudie;
            ...
            public void run() {
                switch (mType) {
                    case TYPE_LIST:
                        ...
                        break;
                    case TYPE_COLLECT:
                        mNewbieGuide.setEveryWhereTouchable(false).addIndicateImg(R.drawable.right, ScreenUtils.dpToPx(mActivity, -70), ScreenUtils.dpToPx(mActivity,
