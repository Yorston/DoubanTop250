...
public class JsonBean implements Serializable {
     ...
     * start : 0
     * total : 250
     * subjects : [{"rating":{"max":10,"average":9.6,"stars":"50","min":0},"genres":["犯罪","剧情"],"title":"肖申克的救赎","casts":[{"alt":"https://movie.douban.com/celebrity/1054521/","avatars":{"small":"https://img3.doubanio.com/img/celebrity/small/17525.jpg","large":"https://img3.doubanio.com/img/celebrity/large/17525.jpg","medium":"https://img3.doubanio.com/img/celebrity/medium/17525.jpg"},"name":"蒂姆·罗宾斯","id":"1054521"},{"alt":"https://movie.douban.com/celebrity/1054534/","avatars":{"small":"https://img3.doubanio.com/img/celebrity/small/34642.jpg","large":"https://img3.doubanio.com/img/celebrity/large/34642.jpg","medium":"https://img3.doubanio.com/img/celebrity/medium/34642.jpg"},"name":"摩根·弗里曼","id":"1054534"},{"alt":"https://movie.douban.com/celebrity/1041179/","avatars":{"small":"https://img1.doubanio.com/img/celebrity/small/5837.jpg","large":"https://img1.doubanio.com/img/celebrity/large/5837.jpg","medium":"https://img1.doubanio.com/img/celebrity/medium/5837.jpg"},"name":"鲍勃·冈顿","id":"1041179"}],"collect_count":944439,"original_title":"The Shawshank Redemption","subtype":"movie","directors":[{"alt":"https://movie.douban.com/celebrity/1047973/","avatars":{"small":"https://img3.doubanio.com/img/celebrity/small/230.jpg","large":"https://img3.doubanio.com/img/celebrity/large/230.jpg","medium":"https://img3.doubanio.com/img/celebrity/medium/230.jpg"},"name":"弗兰克·德拉邦特","id":"1047973"}],"year":"1994","images":{"small":"https://img3.doubanio.com/view/movie_poster_cover/ipst/public/p480747492.jpg","large":"https://img3.doubanio.com/view/movie_poster_cover/lpst/public/p480747492.jpg","medium":"https://img3.doubanio.com/view/movie_poster_cover/spst/public/p480747492.jpg"},"alt":"https://movie.douban.com/subject/1292052/","id":"1292052"}]
     * title : 豆瓣电影Top250
     */
   ...
   /*@Override
    public String toString() {
        ...
        for(int i = 0;i<getSubjects().size();i++){
            //getSubjects().get(i).toString();
            list.add(getSubjects().get(i).getMap());
            //subjects.append(getSubjects().get(i).toString());
        }
    ...
    public static class SubjectsBean implements Serializable{
        ...
        /*@Override
        public String toString() {
            StringBuffer castsbuffer = new StringBuffer("演员:");
            StringBuffer directsbuffer = new StringBuffer("导演:");
            for(int i = 0; i<getCasts().size();i++){
                castsbuffer.append(getCasts().get(i).toString());
            }
            for(int i = 0;i<getDirectors().size();i++){
                directsbuffer.append(getDirectors().toString());
            }
            String subjects = getTitle() + "\n" + getRating().toString() + castsbuffer.toString() + "\n"
                    + directsbuffer.toString() +"\n" + getYear(); //+ getImages().toString();
            subjects = subjects.replaceAll("\\[", "");
            subjects = subjects.replaceAll("\\]", "");
            map = new HashMap<String, String>();
            map.put("BaseInfo", subjects);
            map.put("ImageUrl", getImages().toString());
            return subjects;
        }*/
        ...
        public HashMap<String, String> getMap(){
            ...
            map.put("BaseInfo", subjects);
            map.put("ImageUrl", getImages().toString());
            map.put("MovieCover", getImages().getLarge());
            map.put("MovieTitle", getTitle());
            return map;
        }
        ...
        public static class CastsBean implements Serializable {
            ...
            public static class AvatarsBean implements Serializable {
                ...
                @Override
                public String toString() {
                    String avatarsImgeUrl ="演员相片url" +  getSmall() + "\n" + getMedium() + "\n" + getLarge();
                    return avatarsImgeUrl;
                }
            }
        }
        ...
        public static class DirectorsBean implements Serializable {
            ...
            public static class AvatarsBean implements Serializable {
                ...
                @Override
                public String toString() {
                    String avatarsImgeUrl ="导演相片url" + getSmall() + "\n" + getMedium() + "\n" + getLarge();
                    return avatarsImgeUrl;
                }
            }
        }
